...
deploy_stack_to_region() {
  local REGION=$1
  local STATE_MACHINE_ARN=$(get_config_value "StateMachineArnForLambdaNewSpotInstance-$REGION")
...
FILENAME="template_CloudWatchForStepFunctionForNewSpotInstance.yaml"
