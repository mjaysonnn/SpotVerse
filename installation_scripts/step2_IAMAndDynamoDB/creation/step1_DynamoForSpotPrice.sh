...
echo "Starting to deploy the stack for DynamoDB for Spot Price..."

# Variables
FILENAME="template_step1_DynamoForSpotPrice.yaml"

# Fetch STACK_NAME and REGION using the get_config_value function
STACK_NAME=$(get_config_value "StackName_DynamodbForSpotPrice")
