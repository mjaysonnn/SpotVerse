...
FILENAME="cloudformation_for_cloudwatch_for_dynamodb_for_spot_placement_score.yaml"
STACK_NAME=$(awk -F "=" '/stack_for_cloudwatch_for_spot_placement_score/ {print $2}' ../conf.ini | tr -d ' ')
